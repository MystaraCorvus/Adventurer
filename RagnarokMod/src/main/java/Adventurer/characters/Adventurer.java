...
//All text (starting description and loadout, anything labeled TEXT[]) can be found in AdventurerMod-character-Strings.json in the resources
...
public class Adventurer extends CustomPlayer {
    ...
    public Adventurer(String name, PlayerClass setClass) {
        ...
        initializeClass(null, // required call to load textures and setup energy/loadout.
                // I left these in AdventurerMod.java (Ctrl+click them to see where they are, Ctrl+hover to see what they read.)
