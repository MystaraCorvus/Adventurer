...
public class Strike_Magician extends AdventurerCard {

    public static final String ID = makeID(Strike_Magician.class.getSimpleName());
    private static final CardRarity RARITY = CardRarity.BASIC;
    private static final CardTarget TARGET = CardTarget.ENEMY;
    private static final CardType TYPE = CardType.ATTACK;

    private static final CardColor COLOR = AdventurerColor.MAGICIAN;
