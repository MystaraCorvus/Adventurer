...
import Adventurer.relics.BottledPlaceholderRelic;
...
//TODO: DON'T MASS RENAME/REFACTOR
//TODO: DON'T MASS RENAME/REFACTOR
// Please don't just mass replace "Adventurer" with "yourMod" everywhere.
// It'll be a bigger pain for you. You only need to replace it in 3 places.
// I comment those places below, under the place where you set your ID.

//TODO: FIRST THINGS FIRST: RENAME YOUR PACKAGE AND ID NAMES FIRST-THING!!!
// Right click the package (Open the project pane on the left. Folder with black dot on it. The name's at the very top) -> Refactor -> Rename, and name it whatever you wanna call your mod.
// Scroll down in this file. Change the ID from "Adventurer:" to "yourModName:" or whatever your heart desires (don't use spaces). Dw, you'll see it.
// In the JSON strings (resources>localization>eng>[all them files] make sure they all go "yourModName:" rather than "Adventurer". You can ctrl+R to replace in 1 file, or ctrl+shift+r to mass replace in specific files/directories (Be careful.).
...
public class AdventurerMod implements
    ...
    private static final String DESCRIPTION = "A base for Slay the Spire to start your own mod from, feat. the Adventurer.";
    ...
    public static void initialize() {
        logger.info("========================= Initializing Adventurer Mod. Hi. =========================");
        AdventurerMod defaultmod = new AdventurerMod();
        logger.info("========================= /Adventurer Mod Initialized. Hello World./ =========================");
    }
