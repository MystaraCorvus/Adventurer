...
import Adventurer.orbs.DefaultOrb;
...
public class OrbSkill extends AbstractDynamicCard {
     ...
     * Orb time.
     *
     * Channel 1 Adventurer Orb.
     */

    // TEXT DECLARATION

    public static final String ID = AdventurerMod.makeID(OrbSkill.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ChannelAction(new DefaultOrb())); // Channel a Adventurer Orb.
