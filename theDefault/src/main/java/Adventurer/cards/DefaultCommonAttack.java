...
// Abstract Adventurer Card extends CustomCard and builds up on it, adding a second magic number. Your card can extend it and
// bam - you can have a second magic number in that card (Learn Java inheritance if you want to know how that works).
// Abstract Dynamic Card builds up on Abstract Adventurer Card even more and makes it so that you don't need to add
...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = AdventurerMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main AdventurerMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and Adventurer.variable.DefaultCustomVariable
